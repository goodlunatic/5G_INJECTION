...
bool UETracker::init()
{
  ...
  //printf("[test yg] Created UEULWorker pusch scs:%d\n", phy_cfg.pusch.scs_cfg);
  //printf("[test yg] Created UEULWorker pdsch scs:%d\n", phy_cfg.pdsch.scs_cfg);

  //test yg not changed
  //phy_cfg.pusch.scs_cfg = config.scs_common;
  //phy_cfg.pdsch.scs_cfg = config.scs_common;
